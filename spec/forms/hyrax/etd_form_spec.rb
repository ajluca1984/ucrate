...
RSpec.describe Hyrax::EtdForm do
  ...
  describe "#required_fields" do
    ...
    it { is_expected.to eq [:title, :creator, :description, :college, :department, :advisor] }
  end
  ...
  describe "#primary_terms" do
    ...
    it {
      is_expected.to eq [:title, :creator, :description, :college, :department, :advisor,
                         :committee_member, :degree, :etd_publisher,
